 ...
 */
final class Version20221130083555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pret_instrument DROP FOREIGN KEY pret_instrument_ibfk_1');
        ...
        $this->addSql('ALTER TABLE cours CHANGE libelle libelle VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pret_instrument (id INT AUTO_INCREMENT NOT NULL, eleve_id INT NOT NULL, instrument_id INT NOT NULL, date_pret DATE NOT NULL, INDEX IDX_DA6D552CCF11D9C (instrument_id), INDEX IDX_DA6D552CA6CC7B2 (eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE professeur_cours (id INT AUTO_INCREMENT NOT NULL, compte_id INT NOT NULL, UNIQUE INDEX UNIQ_6C94E7E2F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE pret_instrument ADD CONSTRAINT FK_DA6D552CA6CC7B2 FOREIGN KEY (eleve_id) REFERENCES eleve (id)');
        $this->addSql('ALTER TABLE pret_instrument ADD CONSTRAINT pret_instrument_ibfk_1 FOREIGN KEY (instrument_id) REFERENCES instrument (id)');
        ...
        $this->addSql('ALTER TABLE cours CHANGE libelle libelle VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE eleve DROP FOREIGN KEY FK_ECA105F753C59D72');
